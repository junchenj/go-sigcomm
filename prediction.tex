...
Since weights reflect statistical properties of the identical groups and are thus updated when new quality samples are collected.
...
%; we discuss this further in \Section~\ref{sec:impl} \jc{make sure we cover it}.
