...
(c) gives persistence of pair of [finest group, optimal AC] (the longest continous duration where a finest group has the same optimal AC) and it shows that there is at most 40\% of pair of [finest group, optimal AC] last more than 10 minutes. This implies that even a reactive strategy will miss many optimal AC.}
