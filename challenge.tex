...
\tightcaption{Impact of partition size (i.e., number of samples in a partition). They show that more samples give less prediction error, but most of partitions do not have sufficient samples for accurate prediction.}
