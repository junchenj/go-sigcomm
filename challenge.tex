...
\myparatight{Optimal AC} We use a simple oracle methodology, called {\it optimal AC}, to illustrate the impact of the aggregation granularity on the prediction accuracy. We assume a prediction algorithm with a one-minute window, i.e., it makes prediction based on the quality samples collected during the last minute.
