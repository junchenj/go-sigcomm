...
With more and more interactive and video applications being deployed
  ...
  In this paper we make three arguments. First, we argue that 
  ...
  connections. Third, to make a prediciton on a new session, 
  there may not have enough sessions that are exactly the same, we need
  to use information from ``similar" sessions using aggregation.
