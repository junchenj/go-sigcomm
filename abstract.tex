...
With more and more interactive and video applications being deployed
  ...
  achieve better quality, one needs to accurately predict the
  outcomes of the available choices (e.g., would a streaming
  video client be able to sustain a particular bitrate?). Second, we argue that to
  ...
  making initial bitrate and CDN selections, GO can simultaneously
  increase the average bitrate and reduce the amount of time spent
  buffering.  Improvement is XXX on average, and up to XXX for certain
  classes of clients.
