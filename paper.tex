...
\newcommand{\tightsection}[1]{\vspace{-0.05in}\section{#1}\vspace{-0.1cm}}
\newcommand{\tightsubsection}[1]{\vspace{-0.05in}\subsection{#1}\vspace{-0.1cm}}
\newcommand{\tightsubsubsection}[1]{\vspace{-0.05in}\subsubsection{#1}\vspace{-0.1cm}}
...
\newcommand{\henry}[1]{{\footnotesize\color{blue}[HM: #1]}}
\newcommand{\ion}[1]{{\footnotesize\color{blue}[IS: #1]}}
