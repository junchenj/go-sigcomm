...
\begin{packedenumerate}
	\item set up technical report and add reference
	\item add conclusion
	\item spelling check
	\item crystalize diff to last sigcomm paper
	\item change identical group to parition
	\item add clarification of buffering ratio and rebuffering ratio in sec 4.
\end{packedenumerate}
